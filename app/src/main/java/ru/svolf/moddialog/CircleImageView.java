...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context) {
        ...
        this.mFillColor = DEFAULT_BORDER_COLOR;
        this.mDisableCircularTransformation = false;
        init();
    }

    public CircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, DEFAULT_BORDER_COLOR);
    }
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        try {
            ...
            drawable.setBounds(DEFAULT_BORDER_COLOR, DEFAULT_BORDER_COLOR, canvas.getWidth(), canvas.getHeight());
